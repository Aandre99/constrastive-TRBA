...
if __name__ == '__main__':
    ...
    parser.add_argument('--SequenceModeling', type=str, required=True,
                        help='SequenceModeling stage. None|BiLSTM|Transformer. '
                             'Com --attention_type 2D: BiLSTM usa raster scan sobre H\'×W\', '
                             'Transformer (default) usa TransformerEncoder, None usa projeção linear.')
